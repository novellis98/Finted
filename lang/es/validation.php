...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí puede especificar mensajes personalizados de validación para atributos
    | usando la convención "attribute.rule" para nombrar las líneas. Esto hace que
    | sea rápido especificar una línea de lenguaje personalizada para una regla de
    | validación dada.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de lenguaje se utilizan para reemplazar el marcador de
    | posición del atributo con algo más fácil de leer, como "Dirección de correo
    | electrónico" en lugar de "email". Esto simplemente nos ayuda a hacer el mensaje
    | más expresivo.
    |
    */
