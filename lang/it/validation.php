...
return [
    ...
    | utilizzati dalla classe di validazione. Alcune di queste regole hanno versioni
    | multiple, come le regole di dimensione. Sentiti libero di modificare ciascuno
    | di questi messaggi qui.
    |
    */
    ...
    'lte' => [
        ...
        'string' => 'Il campo :attribute deve essere più corto o uguale a :value caratteri.',
    ],
    ...
    /*
    |--------------------------------------------------------------------------
    | Pagine di Traduzioni Personalizzate
    |--------------------------------------------------------------------------
    |
    | Qui puoi specificare dei messaggi personalizzati per la validazione degli
    | attributi, utilizzando la convenzione "nome-attributo.regola" per nominare
    | le righe. Questo ti permette di fornire messaggi specifici per una determinata
    | regola di validazione in modo rapido.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Attributi di Traduzione Personalizzati
    |--------------------------------------------------------------------------
    |
    | Le righe seguenti sono usate per sostituire il segnaposto dell'attributo
    | con qualcosa di più leggibile, come "Indirizzo E-Mail" invece di "email".
    | Questo aiuta a rendere i nostri messaggi più espressivi.
    |
    */
